...
export const socketServerURL = 'http://trebuchet.xyz:3000';

export const singlePlayerQNos = 10;
export const multiPlayerQNos = 10;
...
export const errorCodes = {
	...
	4: "No internet connection or server is down. Please try again after some time."
};